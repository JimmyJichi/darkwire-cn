...
export default class Darkwire {
  ...
  generateMessage(fileId, fileName, messageType) {
    let message = '<div id="file-transfer-request-' + fileId + '">正在向你發送 <strong>' + fileName + '</strong> (' + messageType + ')';
    message += '<br><a class="file-download" onclick="triggerFileDownload(this);" data-file="' + fileId + '">接收檔案</a></div>';
